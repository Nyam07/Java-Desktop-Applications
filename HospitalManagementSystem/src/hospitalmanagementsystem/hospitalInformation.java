...
public class hospitalInformation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Statement st = conn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_READ_ONLY);\nThis removes the error where the resultset only moves in a forward direction by allowing it to move backwards also.\n\n jTable1.setModel(DbUtils.resultSetToTableModel(rs));\nThe above line of code maps da record from a database into a table in the Jframe\nYou must import: import net.proteanit.sql.DbUtils;");
